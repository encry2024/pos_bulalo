<?php $__env->startSection('title', 'Dry Good Stock Management | Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::model($stock, ['route' => ['admin.dry_good.stock.update', $stock], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-Stock'])); ?>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        <?php echo e(Form::text('name', $stock->inventory->name, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'readonly' => 'true'])); ?>
