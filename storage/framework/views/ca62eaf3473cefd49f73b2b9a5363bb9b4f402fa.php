<?php $__env->startSection('title', 'Dry Good Disposal Form | Dispose Item'); ?>
...
<?php $__env->startSection('page-header'); ?>
    <h1>
        Dry Good Disposal Form <small>Dispose Item</small>
    </h1>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['route' => 'admin.dry_good.dispose.store', 'class' => 'form-horizontal', 'Product' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?php echo $__env->make('backend.dry_good.dispose.includes.partials.dispose-header-buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4" id="item_panel">
                        <?php echo e(Form::select('inventory_id', count($inventories) ? $inventories : $inventories, old('inventory_id'), ['class' => 'form-control date', 'maxlength' => '191', 'required' => 'required'])); ?>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    <?php echo e(link_to_route('admin.dry_good.dispose.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs'])); ?>
...
<?php $__env->startSection('after-scripts'); ?>
    ...
    <script>
        var inventories = '<?php echo Form::select("inventory_id", $inventories, old("inventory_id"), ["class" => "form-control", "required" => "required"]); ?>';
