<?php $__env->startSection('title', 'Commissary Daily Report'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="col-lg-12">
                <?php echo e(Form::open(['route' => 'admin.report.commissary.daily.sale.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post'])); ?>
           ...
           <table class="table table-responsive table-bordered" id="daily_log_table">
                ...
                <tbody>
                    ...
                    <?php if(count($reports)): ?>
                        ...
                        <tr>
                            <td colspan="11" style="color:red"><?php echo e($report->category); ?></td>
                        </tr>
                            <?php 
