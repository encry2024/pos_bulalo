...
<?php echo e(Html::style('css/sweetalert2.css')); ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a class="product-box" id="<?php echo e($product->id); ?>" data-code="<?php echo e($product->code); ?>" onclick="product_click(this)">
                                            <div class="product-title"><?php echo e($product->name); ?></div>

                                            <div class="product-body">
                                                <img src="<?php echo e(url('img/product').'/'.$product->image); ?>">
                                            </div>
                                        </a>
                        ...
                        <div class="col-lg-12" id="payment">
                            ...
                            <div class="form-group col-lg-6" id="panel_discount_type" hidden>
                                ...
                                <select class="form-control" id="discount_type">
                                    ...
                                    <option value="<?php echo e($setting->discount); ?>"><?php echo e($setting->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select> 
                            </div>
                    ...
                    <div class="scrollable">
                        <div id="official_receipt">
                            ...
                            <div id="printable">
                                ...
                                <p>Date: <span class="pull-right"><?php echo e(date('m-d-y - h:i:s A')); ?></span></p>
                                <p>Cashier: <span class="pull-right"><?php echo e(Auth::user()->name); ?></span></p>
...
<?php $__env->startSection('after-scripts'); ?>
    <?php echo e(Html::script('js/sweetalert2.all.min.js')); ?>
    ...
    <script type="text/javascript">
        ...
        function getIngredients(id){
            $.ajax({
                type: 'get',
                url : '<?php echo e(url("dashboard")); ?>/' + id + '/product',
        ...
        $('#btn-tables').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo e(url("sale/unpaid")); ?>',
                success: function(data) {
                    var options = '';
                    total_amt = 0;
        ...
        $('#btn_additional').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url : '<?php echo e(url("sale/get_order_list")); ?>/' + transaction_no,
                success: function(data) {
                    var html = '';
        ...
        $('#btn-charge').on('click', function() {
            ...
            if($('#table_list').find('option').length > 0)
            {
                $.ajax({
                    type: 'GET',
                    url : '<?php echo e(url("sale/get_order_list")); ?>/' + transact_no,
                    success: function(data) {
                        var html = '';
                        var total = 0;
        ...
        $('#btn_charge_submit').on('click', function() {
            ...
            if(cash >= (payable - discount))
            {
               $('#btn_charge_submit').attr('readonly','');
                ...
                $.ajax({
                    url: '<?php echo e(url("sale/charge_save")); ?>',
                    type: 'POST',
                    data: {
        ...
        function table_order(val)
        {
            $.ajax({
                type: 'GET',
                url: '<?php echo e(url("sale/order")); ?>/' + val,
                success: function(data) {
                    data = JSON.parse(data);
                    var rows = '';
            ...
            if(row_count > 0)
            {
                    ...
                    preConfirm: (password) => 
                    {
                        return new Promise((resolve) => 
                        {
                            $.ajax(
                                {
                                    type: 'get',
                                    url: '<?php echo e(url("admin_password")); ?>/' + password,
                                    success: function(data) 
                                    {
                                        if(data > 0)
                                            resolve();
                ...
                }).then((result) => 
                {
                    if (result.value) 
                    {
                        ...
                        $.ajax({
                            type: 'POST',
                            url : '<?php echo e(url("sale/cancel_order")); ?>',
                            data: {
        ...
        function get_available_table()
        {
            $.ajax({
                type: 'GET',
                url: '<?php echo e(url("sale/available_table")); ?>',
                success: function(data) {
                    data = JSON.parse(data);
                    var options = '';
