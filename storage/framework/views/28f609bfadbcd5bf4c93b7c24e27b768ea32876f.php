...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['route' => 'admin.product.store', 'class' => 'form-horizontal', 'Product' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <?php echo e(Form::text('code', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required'])); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <?php echo e(Form::file('image', old('image'), ['class' => 'form-control', 'required' => 'required'])); ?>
