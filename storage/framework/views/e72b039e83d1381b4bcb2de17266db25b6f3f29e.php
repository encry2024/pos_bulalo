<?php $__env->startSection('title', 'Commissary Inventory Management | Edit Item'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::model($inventory, ['route' => ['admin.commissary.inventory.update', $inventory], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-Inventory'])); ?>
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo e(Form::text(
                                'inventory_id', 
                                $inventory->supplier == 'Other' ? $inventory->other_inventory->name : $inventory->drygood_inventory->name, 
                                [
                                    'class' => 'form-control', 
                                    'maxlength' => '191', 
                                    'required' => 'required', 
                                    'autofocus' => 'autofocus', 
                                    'placeholder' => trans('validation.attributes.backend.access.roles.name')
                                ]
                            )); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('reorder_level', 'Reorder Level', ['class' => 'col-lg-2 control-label'])); ?>
        ...
        <div class="box box-success">
            <div class="box-body">
                <div class="pull-left">
                    <?php echo e(link_to_route('admin.commissary.inventory.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs'])); ?>
