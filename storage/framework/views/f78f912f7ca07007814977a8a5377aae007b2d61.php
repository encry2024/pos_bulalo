<?php $__env->startSection('title', 'Commissary Stock In | Add Stock'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['route' => 'admin.commissary.stock.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post'])); ?>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?php echo $__env->make('backend.commissary.stock.includes.partials.stock-header-buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    ...
                    <div class="col-lg-10">
                        <select name="inventory_id" id="inventory_id" class="form-control select-inventory">
                            ...
                            <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($inventory->supplier == "Other"): ?>
                                    <option value="<?php echo e($inventory->id); ?>"><?php echo e($inventory->other_inventory->name); ?></option>
                                <?php else: ?>
                                    <option value="<?php echo e($inventory->id); ?>"><?php echo e($inventory->drygood_inventory->name); ?></option>
                                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            ...
                            <input name="quantity" type="number" class="form-control" maxlength="191" required="required" id="item-quantity" min="0" value="<?php echo e(old('stock')); ?>">
                        </div>
                    </div>
...
<?php $__env->startSection('after-scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $("#inventory_id").change(function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('admin.commissary.stock.get_item')); ?>",
                data: {
