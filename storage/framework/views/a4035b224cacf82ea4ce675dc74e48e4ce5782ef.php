        ...
        <div class="col-xs-12">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                 <?php echo e(Form::open(['route' => 'frontend.user.request.store', 'class' => 'form-horizontal', 'Product' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>


                 <div class="form-group">
                    <?php echo e(Form::label('title', 'Title', ['class' => 'col-lg-2 control-label'])); ?>


                    <div class="col-lg-4">
                        <?php echo e(Form::text('title', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus'])); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('message', 'Message', ['class' => 'col-lg-2 control-label'])); ?>
                    ...
                    <div class="col-lg-9 col-offset-lg-1">
                        <?php echo e(Form::textarea('message', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'rows' => '6'])); ?>

                        <?php echo e(Form::hidden('requests', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'id' => 'requests'])); ?>

                    </div>
                </div>

                <div class="form-group">
                  <?php echo e(Form::label('ingredient_list', 'Ingredient List', ['class' => 'col-lg-2 control-label'])); ?>


                    <div class="col-lg-4">
                        <?php echo e(Form::select('ingredient_list', $selections, null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'id' => 'ingredient_list'])); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('quantity', 'Quantity', ['class' => 'col-lg-2 control-label'])); ?>
                    ...
                    <div class="col-lg-4">
                        <?php echo e(Form::number('quantity', '1', ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'id' => 'quantity' ])); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('unit_type', 'Unit Type', ['class' => 'col-lg-2 control-label'])); ?>
                    ...
                    <div class="col-lg-4">
                        <?php echo e(Form::text('unit_type', 'Other', ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'id' => 'unit_type', 'readonly' => 'readonly' ])); ?>
...
<?php $__env->startSection('after-scripts'); ?>
  ...
  <script type="text/javascript">
    ...
    <?php if(count($ingredients)): ?>
      getUnitType(<?php echo e($ingredients[0]['id']); ?>);
    <?php endif; ?>
    ...
    function getUnitType(id)
    {
      $.ajax(
        {
          type: 'GET',
          url : '<?php echo e(URL::to("/request/unit_type")); ?>/' + id,
