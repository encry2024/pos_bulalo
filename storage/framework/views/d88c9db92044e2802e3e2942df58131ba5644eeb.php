                    ...
                    <?php if(count($products)): ?>
                        ...
                        <?php $total = 0; ?> 
                            <tr>
                                ...
                                <!-- beginning -->
                                <td><?php echo e($qty  = $product->beginning->quantity); ?></td>
                                <td><?php echo e($cost = number_format($product->beginning->cost, 2)); ?></td>
                                <td style="background-color:yellow">
                                    <?php 
                                        $sub   = number_format($cost * $qty, 2);
                                ...
                                <!-- delivery -->
                                <td><?php echo e($qty  = $product->delivery->quantity); ?></td>
                                <td><?php echo e($cost = number_format($product->delivery->cost, 2)); ?></td>
                                <td style="background-color:yellow">
                                    <?php 
                                        $sub   = number_format($cost * $qty, 2);
                                ...
                                <!-- sales -->
                                <td><?php echo e($qty  = $product->sale->quantity); ?></td>
                                <td><?php echo e($cost = number_format($product->sale->cost, 2)); ?></td>
                                <td style="background-color:yellow">
                                    <?php 
                                        $sub   = number_format($cost * $qty, 2);
                                        $total = $sub;
                                ...
                                <td>&nbsp;</td>
                                <td><?php echo e($product->dispose->quantity.'/'.$product->dispose->cost); ?></td>
                                <td><?php echo e(number_format($total, 2)); ?></td>
                                <td><?php echo e($product->ending); ?></td>
                                <td><?php echo e($product->actual); ?></td>
                                <td></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
