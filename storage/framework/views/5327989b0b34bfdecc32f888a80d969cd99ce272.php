<?php $__env->startSection('title', 'Commissary Goods Return'); ?>
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <?php echo $__env->make('backend.commissary.goods_return.includes.partials.goods-return-header-buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
        $(function() {
            $('#users-table').DataTable({
                ...
                processing: false,
                serverSide: true,
                ajax: '<?php echo route('admin.commissary.goods_return.get'); ?>',
                columns: [
                    { data: 'name' },
                    { data: 'date' },
                    { data: 'quantity' },
