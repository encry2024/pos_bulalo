<?php echo e(Form::model($logged_in_user, ['route' => 'frontend.user.profile.update', 'class' => 'form-horizontal', 'method' => 'PATCH'])); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <?php echo e(Form::text('last_name', null, ['class' => 'form-control', 'required' => 'required', 'maxlength' => '191', 'placeholder' => trans('validation.attributes.frontend.last_name')])); ?>
    ...
    <?php if($logged_in_user->canChangeEmail()): ?>
        <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <?php echo e(Form::email('email', null, ['class' => 'form-control', 'required' => 'required', 'maxlength' => '191', 'placeholder' => trans('validation.attributes.frontend.email')])); ?>
