...
@section ('title', 'Dry Good Inventory Management | Edit Item')
...
@section('content')
    {{ Form::model($inventory, ['route' => ['admin.dry_good.inventory.update', $inventory], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-Inventory']) }}
