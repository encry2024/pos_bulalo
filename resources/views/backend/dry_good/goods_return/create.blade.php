...
@section ('title', 'Dry Goods Return | Return Item')
...
@section('content')
    {{ Form::open(['route' => 'admin.dry_good.goods_return.store', 'class' => 'form-horizontal', 'Product' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.dry_good.goods_return.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
