...
@section ('title', 'Dry Good Stock Management | Edit')
...
@section('content')
    {{ Form::model($stock, ['route' => ['admin.dry_good.stock.update', $stock], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-Stock']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <span class="input-group-addon">{{ $stock->inventory->unit_type }}</span>
                            {{ Form::number('quantity', old('quantity'), ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required']) }}
                        </div>
                    </div>
