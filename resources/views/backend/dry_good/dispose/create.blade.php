...
@section ('title', 'Dry Good Disposal Form | Dispose Item')
...
@section('content')
    {{ Form::open(['route' => 'admin.dry_good.dispose.store', 'class' => 'form-horizontal', 'Product' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4" id="item_panel">
                        {{ Form::select('inventory_id', count($inventories) ? $inventories : $inventories, old('inventory_id'), ['class' => 'form-control date', 'maxlength' => '191', 'required' => 'required']) }}
                    </div>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.dry_good.dispose.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
