                ...
                <table id="daily_log_table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan='10' style="text-align: left">{{ $barista->morning }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <!-- 
                         ...
                         <tr>
                            <td>&nbsp;</td>
                            <td colspan="4" style="text-align: right"><b>Branch</b> </td>
                            <td colspan='10'></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="4" style="text-align: right"><b>Barista</b> </td>
                            <td colspan='10' style="text-align: left"><b>{{ $barista->afternoon }}</b></td>
                        </tr>
