                            ...
                            @if(count($objects->items))
                                ...
                                @foreach($objects->items as $item)
                                    <?php 
                                        ...
                                        $mon   = $item->days['mon']->stocks;
                                        $tue   = $item->days['tue']->stocks;
                                        $wed   = $item->days['wed']->stocks;
                                        $thurs = $item->days['thurs']->stocks;
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->stock + $mon + $tue + $wed + $thurs  }}</td>
                                        <td>{{ $mon }}</td>
                                        <td>{{ $tue }}</td>
                                        <td>{{ $wed }}</td>
                                        <td>{{ $thurs }}</td>
                                        <td>
                                            <?php 
                                                $total    = number_format(($mon + $tue + $wed + $thurs) * $cost, 2);
